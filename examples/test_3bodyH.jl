...
@testset "Investigate suprise effects of the inital sweep direction for 3 body Hamiltonian" begin
    ...
    for N in 3:10
        ...
        Dw1_L,Dw1_R,Dw1i_L,Dw1i_R=maxlinkdim(HhandL),maxlinkdim(HhandR),maxlinkdim(Hhand_infL),maxlinkdim(Hhand_infR)
        ...
        Dw2_L,Dw2_R,Dw2i_L,Dw2i_R=maxlinkdim(HhandL),maxlinkdim(HhandR),maxlinkdim(Hhand_infL),maxlinkdim(Hhand_infR)
