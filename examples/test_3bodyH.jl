...
@testset "Investigate suprise effects of the inital sweep direction for 3 body Hamiltonian" begin
    ...
    for N in 3:8
        ...
        orthogonalize!(HhandL;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(HhandR;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hhand_infL;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hhand_infR;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        Dw1_L,Dw1_R,Dw1i_L,Dw1i_R=max_Dw(HhandL),max_Dw(HhandR),max_Dw(Hhand_infL),max_Dw(Hhand_infR)
        orthogonalize!(HhandL;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(HhandR;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hhand_infL;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hhand_infR;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
...
@testset "Tabulate MPO Dw reduction for 3 body Hamiltonian" begin
    ...
    for N in 3:11
        ...
        orthogonalize!(Hhand;epsrr=1e-14)
        orthogonalize!(Hauto;epsrr=1e-14)
        Gs_hand=orthogonalize!(Hhand_inf;epsrr=1e-14)
        Dw_hand_orth,Dw_auto_orth=max_Dw(Hhand),max_Dw(Hauto)
        Dw_handinf_orth=max_Dw(Hhand_inf)
        ss_hand=truncate!(Hhand;cutoff=1e-15,epsrr=1e-15)
        ss_auto=truncate!(Hauto;cutoff=1e-15,epsrr=1e-15)
        truncate!(Hhand_inf,Gs_hand,left;cutoff=1e-15,epsrr=1e-15)
...
# findJs(sites,mpo)
# @show get_Dw(mpo)
# orthogonalize!(mpo;epsrr=1e-12,verbose=true)
# # orthogonalize!(mpo;max_sweeps=1,orth=right,epsrr=1e-12,verbose=true)
# # orthogonalize!(mpo;max_sweeps=1,orth=left,epsrr=1e-12,verbose=true)
# # orthogonalize!(mpo;max_sweeps=1,orth=right,epsrr=1e-12,verbose=true)
# ss=truncate!(mpo;cutoff=1e-15,epsrr=1e-12,verbose=true)
# @show get_Dw(mpo) 
# pprint(mpo[10],1e-14)
# findJs(sites,mpo)
