...
@testset "Investigate suprise effects of the inital sweep direction" begin
    ...
    for NNN in [1,5,8]
        ...
        orthogonalize!(HdumbL;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(HdumbR;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hdumb_infL;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hdumb_infR;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        Dw1_L,Dw1_R,Dw1i_L,Dw1i_R=max_Dw(HdumbL),max_Dw(HdumbR),max_Dw(Hdumb_infL),max_Dw(Hdumb_infR)
        orthogonalize!(HdumbL;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(HdumbR;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hdumb_infL;verbose=verbose,orth=right,max_sweeps=1,epsrr=1e-14)
        orthogonalize!(Hdumb_infR;verbose=verbose,orth=left,max_sweeps=1,epsrr=1e-14)
...
@testset "Tabulate MPO Dw reduction for 2 body NNN interactions" begin
    ...
    for NNN in 1:15
        ...
        orthogonalize!(Hpres;epsrr=1e-14)
        orthogonalize!(Hdumb;epsrr=1e-14)
        orthogonalize!(Hauto;epsrr=1e-14)
        Gs_pres=orthogonalize!(Hpres_inf;epsrr=1e-14)
        Gs_dumb=orthogonalize!(Hdumb_inf;epsrr=1e-14)
        ...
        ss_pres=truncate!(Hpres;cutoff=1e-15,epsrr=1e-15)
        ss_dumb=truncate!(Hdumb;cutoff=1e-15,epsrr=1e-15)
        ss_auto=truncate!(Hauto;cutoff=1e-15,epsrr=1e-15)
        truncate!(Hpres_inf,Gs_pres,left;cutoff=1e-15,epsrr=1e-15)
        truncate!(Hdumb_inf,Gs_dumb,left;cutoff=1e-15,epsrr=1e-15)
