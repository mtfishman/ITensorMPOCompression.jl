...
@testset "Investigate suprise effects of the inital sweep direction" begin
  ...
  for NNN in [1, 5, 8, 12, 14]
    ...
    HdumbL = orthogonalize!(HdumbL, left; verbose=verbose, cutoff=1e-14)
    HdumbR = orthogonalize!(HdumbR, right; verbose=verbose, cutoff=1e-14)
    ...
    HdumbL = orthogonalize!(HdumbL, right; verbose=verbose, cutoff=1e-14)
    HdumbR = orthogonalize!(HdumbR, left; verbose=verbose, cutoff=1e-14)
